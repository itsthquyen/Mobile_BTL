    ...
    final List<Map<String, dynamic>> documents = [
      {
        'icon': Icons.public,
        'label': 'Passport',
        'onTap': () => debugPrint('Open Passport'),
      },
      {
        'icon': Icons.credit_card,
        'label': 'ID Card',
        'onTap': () => debugPrint('Open ID Card'),
      },
      {
        'icon': Icons.badge,
        'label': 'Driver License',
        'onTap': () => debugPrint('Open Driver License'),
      },
    ];
...
void main() {
  runApp(
    const MaterialApp(
      debugShowCheckedModeBanner: false, // Tắt chữ Debug ở góc cho đẹp
      home: IdentifyPage(),
    ),
  );
}
