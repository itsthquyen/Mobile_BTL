          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? Colors.white : Colors.transparent, // Pill chọn là màu trắng
                  borderRadius: BorderRadius.circular(5),
                ),
                child: Text(
                  expenseTypes[index],
                  style: TextStyle(
                    color: isSelected ? mainBlueColor : Colors.white70, // Text pill chọn là màu xanh
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const Text('₫', style: TextStyle(color: lightTextColor, fontSize: 16)),
        ...
        Expanded(
          child: TextField(
            ...
            style: const TextStyle(color: lightTextColor, fontSize: 18, fontWeight: FontWeight.bold),
            decoration: InputDecoration(
              labelText: 'Amount',
              labelStyle: TextStyle(color: Colors.white54),
              filled: true,
        ...
        child: DropdownButton<String>(
          ...
          items: tripMembers.map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value, overflow: TextOverflow.ellipsis, style: const TextStyle(color: lightTextColor)),
            );
          }).toList(),
  ...
  Widget _buildAddButton() {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: lightTextColor, // Nút hành động cuối cùng màu trắng để nổi bật
      ...
      child: Text(
        'Add',
        style: TextStyle(color: mainBlueColor, fontSize: 18, fontWeight: FontWeight.bold),
      ),
    );
  }
}